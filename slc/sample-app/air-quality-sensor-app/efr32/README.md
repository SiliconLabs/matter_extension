# Matter EFR32 Air Quality Sensor Example
...
[Demo instructions for Thread](https://docs.silabs.com/matter/2.4.0/matter-thread)

## Air Quality Sensor Application User Interface
...
Here is an example for provisioning the air quality sensor application with the chip-tool:
