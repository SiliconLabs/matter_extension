# Matter over Wi-Fi Refrigerator Example

The Matter over Wi-Fi refrigerator example is a baseline demonstration of a fridge built with Simplicity SDK. It can be controlled by a Matter controller over a Wi-Fi network.
...
This example demonstrates a sample implementation of a Matter over Wi-Fi refrigerator
(temperature-controlled cabinet) app running on a Silicon Labs SiWx917 SoC.
