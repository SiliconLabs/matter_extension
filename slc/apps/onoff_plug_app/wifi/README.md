# Matter over Wi-Fi OnOff Plug Example

The Matter over Wi-Fi OnOff Plug example is a baseline demonstration of an OnOff Plug built with Simplicity SDK. It can be controlled by a Matter controller over a Wi-Fi network.
...
This example demonstrates a sample implementation of a Matter over Wi-Fi OnOff Plug app running on a
...
| BTN1    | Press and release | Toggle plug on/off                                              |
...
| LED 1   | Solid on          | Plug is on                                                      |
| LED 1   | Off               | Plug is off                                                     |
