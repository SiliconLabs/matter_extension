# Matter over Thread OnOff Plug Example

The Matter over Thread OnOff Plug example is a baseline demonstration of an OnOff Plug built with Simplicity SDK. It can be controlled by a Matter controller over a Thread network.
...
This example demonstrates a sample implementation of a Matter over Thread OnOff Plug
