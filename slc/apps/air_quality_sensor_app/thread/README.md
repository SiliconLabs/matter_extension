# Matter over Thread Air Quality Sensor Example

The Matter over Thread air quality sensor example is a baseline demonstration of an air quality sensor built with Simplicity SDK. It can be controlled by a Matter controller over a Thread network.
...
This example demonstrates a sample implementation of a Matter over Thread air quality sensor
