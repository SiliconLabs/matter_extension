# Matter over Wi-Fi Oven Example

The Matter over Wi-Fi oven example is a baseline demonstration of an oven built with Simplicity SDK. It can be controlled by a Matter controller over a Wi-Fi network.
...
This example demonstrates a sample implementation of a Matter over Wi-Fi oven
...
4. Control the device using chip-tool or another Matter controller after commissioning. Example pairing: `chip-tool pairing ble-wifi <Node-ID> <SSID> <PSK> 20202021 3840`.
