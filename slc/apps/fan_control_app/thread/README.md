# Matter over Thread Fan Control Example

The Matter over Thread fan control example is a baseline demonstration of a fan device built with Simplicity SDK. It can be controlled by a Matter controller over a Thread network.
...
This example demonstrates a sample implementation of a Matter over Thread fan control
...
4. Control the fan:
   ...
   chip-tool fancontrol read fan-mode-sequence 1 1
   ```
...
| BTN1    | Press and release | Cycle through fan modes                                        |
