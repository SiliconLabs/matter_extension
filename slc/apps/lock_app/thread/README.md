# Matter over Thread Lock Example

The Matter over Thread lock example is a baseline demonstration of a lock device built with Simplicity SDK. It can be controlled by a Matter controller over a Thread network.
...
This example demonstrates a sample implementation of a Matter over Thread lock
