# Matter over Wi-Fi Dishwasher Example

The Matter over Wi-Fi dishwasher example is a baseline demonstration of a dishwasher built with Simplicity SDK. It can be controlled by a Matter controller over a Wi-Fi network.
...
This example demonstrates a sample implementation of a Matter over Wi-Fi dishwasher
