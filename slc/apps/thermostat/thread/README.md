# Matter over Thread Thermostat Example

The Matter over Thread thermostat example is a baseline demonstration of a thermostat built with Simplicity SDK. It can be controlled by a Matter controller over a Thread network.
...
This example demonstrates a sample implementation of a Matter over Thread thermostat
...
4. Control the thermostat using chip-tool or another Matter controller after commissioning.
