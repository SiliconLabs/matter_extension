...
#define RXDC_ACCELERATION_BUFFER rxdcAccelerationBuffer
extern uint32_t rxdcAccelerationBuffer[];

#define RADIO_CONFIG_XTAL_FREQUENCY 38400000UL

#define RAIL0_CHANNELS_PHY_SIGNIFY_ZB_ENHANCED_2CHANNELFS_DUALSYNC
#define RAIL0_CHANNELS_PROFILE_BASE
