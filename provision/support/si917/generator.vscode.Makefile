...
ASM_INCLUDES := -I"config" -I"autogen" -I"../../generator" -I"$(SDK_PATH)/../../../examples" -I"$(SDK_PATH)/../../../examples/platform/silabs" -I"$(SDK_PATH)/../../../src" -I"$(SDK_PATH)/../../../src/platform/silabs/SiWx917" -I"$(SDK_PATH)/../../../src/include" -I"$(SDK_PATH)/../../../zzz_generated/app-common" -I"$(SDK_PATH)/../../nlassert/repo/include" -I"$(SDK_PATH)/../../nlio/repo/include" -I"$(SDK_PATH)/../matter_support/matter/mbedtls/tinycrypt/inc" -I"$(SDK_PATH)/../../mbedtls/repo/library" -I"$(SDK_PATH)/../../mbedtls/repo/include" -I"$(SDK_PATH)/../../../src/lib/support" -I"$(SDK_PATH)/../../../src/platform/silabs" -I"$(SDK_PATH)/../matter_support/matter/si91x/siwx917/BRD4338A/support/inc" -I"$(SDK_PATH)/../wifi_sdk/components/service/bsd_socket/inc" -I"$(SDK_PATH)/../wifi_sdk/components/device/silabs/si91x/mcu/drivers/cmsis_driver/CMSIS/Driver/Include" -I"$(SDK_PATH)/../wifi_sdk/components/device/silabs/si91x/mcu/drivers/cmsis_driver" -I"$(SDK_PATH)/../wifi_sdk/components/service/network_manager/inc" -I"$(SDK_PATH)/../wifi_sdk/components/device/silabs/si91x/mcu/drivers/rom_driver/inc" -I"$(SDK_PATH)/../wifi_sdk/components/device/silabs/si91x/mcu/core/chip/inc" -I"$(SDK_PATH)/../wifi_sdk/components/board/silabs/inc" -I"$(SDK_PATH)/../wifi_sdk/components/device/silabs/si91x/mcu/drivers/peripheral_drivers/inc" -I"$(SDK_PATH)/../wifi_sdk/components/device/silabs/si91x/mcu/core/config" -I"$(SDK_PATH)/../wifi_sdk/components/device/silabs/si91x/mcu/core/common/inc" -I"$(SDK_PATH)/../wifi_sdk/components/device/silabs/si91x/mcu/drivers/service/nvm3/inc" -I"$(SDK_PATH)/../wifi_sdk/components/device/silabs/si91x/wireless/errno/inc" -I"$(SDK_PATH)/../wifi_sdk/components/device/silabs/si91x/wireless/icmp" -I"$(SDK_PATH)/../wifi_sdk/components/device/silabs/si91x/wireless/firmware_upgrade" -I"$(SDK_PATH)/../wifi_sdk/components/device/silabs/si91x/wireless/inc" -I"$(SDK_PATH)/../wifi_sdk/components/device/silabs/si91x/wireless/sl_net/inc" -I"$(SDK_PATH)/../wifi_sdk/components/device/silabs/si91x/wireless/ahb_interface/inc" -I"$(SDK_PATH)/../wifi_sdk/components/device/silabs/si91x/mcu/drivers/systemlevel/inc" -I"$(SDK_PATH)/../wifi_sdk/components/protocol/wifi/inc" -I"$(SDK_PATH)/../wifi_sdk/resources/certificates" -I"$(SDK_PATH)/../wifi_sdk/resources/html" -I"$(SDK_PATH)/../wifi_sdk/resources/other" -I"$(SDK_PATH)/../wifi_sdk/components/common/inc" -I"$(SDK_PATH)/platform/common/inc" -I"$(SDK_PATH)/platform/CMSIS/Core/Include" -I"$(SDK_PATH)/platform/CMSIS/RTOS2/Include" -I"$(SDK_PATH)/platform/service/device_init/inc" -I"$(SDK_PATH)/platform/emdrv/common/inc" -I"$(SDK_PATH)/platform/emlib/inc" -I"$(SDK_PATH)/util/third_party/freertos/cmsis/Include" -I"$(SDK_PATH)/util/third_party/freertos/kernel/include" -I"$(SDK_PATH)/util/third_party/freertos/kernel/portable/GCC/ARM_CM4F" -I"$(SDK_PATH)/platform/service/iostream/inc" -I"$(SDK_PATH)/platform/emdrv/nvm3/inc" -I"$(SDK_PATH)/util/third_party/segger/systemview/SEGGER" -I"$(SDK_PATH)/platform/service/system/inc" 
