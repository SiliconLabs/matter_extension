...
ASM_INCLUDES := -I"config" -I"autogen" -I"../../generator" -I"$(SDK_PATH)/../../../examples" -I"$(SDK_PATH)/../../../examples/platform/silabs" -I"$(SDK_PATH)/../../../src" -I"$(SDK_PATH)/../../../src/include" -I"$(SDK_PATH)/../../../zzz_generated/app-common" -I"$(SDK_PATH)/../../nlassert/repo/include" -I"$(SDK_PATH)/../../nlio/repo/include" -I"$(SDK_PATH)/platform/bootloader" -I"$(SDK_PATH)/protocol/bluetooth/config" -I"$(SDK_PATH)/platform/Device/SiliconLabs/EFR32MG26/Include" -I"$(SDK_PATH)/platform/common/inc" -I"$(SDK_PATH)/platform/CMSIS/Core/Include" -I"$(SDK_PATH)/platform/CMSIS/RTOS2/Include" -I"$(SDK_PATH)/platform/service/device_init/inc" -I"$(SDK_PATH)/platform/emdrv/common/inc" -I"$(SDK_PATH)/platform/emlib/inc" -I"$(SDK_PATH)/util/third_party/freertos/cmsis/Include" -I"$(SDK_PATH)/util/third_party/freertos/kernel/include" -I"$(SDK_PATH)/util/third_party/freertos/kernel/portable/GCC/ARM_CM33_NTZ/non_secure" -I"$(SDK_PATH)/platform/service/interrupt_manager/inc" -I"$(SDK_PATH)/platform/service/interrupt_manager/inc/arm" -I"$(SDK_PATH)/platform/service/iostream/inc" -I"$(SDK_PATH)/platform/security/sl_component/sl_mbedtls_support/config" -I"$(SDK_PATH)/platform/security/sl_component/sl_mbedtls_support/config/preset" -I"$(SDK_PATH)/platform/security/sl_component/sl_mbedtls_support/inc" -I"$(SDK_PATH)/util/third_party/mbedtls/include" -I"$(SDK_PATH)/util/third_party/mbedtls/library" -I"$(SDK_PATH)/platform/service/memory_manager/inc" -I"$(SDK_PATH)/platform/service/memory_manager/src" -I"$(SDK_PATH)/platform/emdrv/nvm3/inc" -I"$(SDK_PATH)/platform/security/sl_component/sl_psa_driver/inc" -I"$(SDK_PATH)/platform/security/sl_component/se_manager/inc" -I"$(SDK_PATH)/platform/security/sl_component/se_manager/src" -I"$(SDK_PATH)/util/third_party/segger/systemview/SEGGER" -I"$(SDK_PATH)/platform/common/toolchain/inc" -I"$(SDK_PATH)/platform/service/system/inc" 
C_INCLUDES := -I"config" -I"autogen" -I"../../generator" -I"$(SDK_PATH)/../../../examples" -I"$(SDK_PATH)/../../../examples/platform/silabs" -I"$(SDK_PATH)/../../../src" -I"$(SDK_PATH)/../../../src/include" -I"$(SDK_PATH)/../../../zzz_generated/app-common" -I"$(SDK_PATH)/../../nlassert/repo/include" -I"$(SDK_PATH)/../../nlio/repo/include" -I"$(SDK_PATH)/platform/bootloader" -I"$(SDK_PATH)/protocol/bluetooth/config" -I"$(SDK_PATH)/platform/Device/SiliconLabs/EFR32MG26/Include" -I"$(SDK_PATH)/platform/common/inc" -I"$(SDK_PATH)/platform/CMSIS/Core/Include" -I"$(SDK_PATH)/platform/CMSIS/RTOS2/Include" -I"$(SDK_PATH)/platform/service/device_init/inc" -I"$(SDK_PATH)/platform/emdrv/common/inc" -I"$(SDK_PATH)/platform/emlib/inc" -I"$(SDK_PATH)/util/third_party/freertos/cmsis/Include" -I"$(SDK_PATH)/util/third_party/freertos/kernel/include" -I"$(SDK_PATH)/util/third_party/freertos/kernel/portable/GCC/ARM_CM33_NTZ/non_secure" -I"$(SDK_PATH)/platform/service/interrupt_manager/inc" -I"$(SDK_PATH)/platform/service/interrupt_manager/inc/arm" -I"$(SDK_PATH)/platform/service/iostream/inc" -I"$(SDK_PATH)/platform/security/sl_component/sl_mbedtls_support/config" -I"$(SDK_PATH)/platform/security/sl_component/sl_mbedtls_support/config/preset" -I"$(SDK_PATH)/platform/security/sl_component/sl_mbedtls_support/inc" -I"$(SDK_PATH)/util/third_party/mbedtls/include" -I"$(SDK_PATH)/util/third_party/mbedtls/library" -I"$(SDK_PATH)/platform/service/memory_manager/inc" -I"$(SDK_PATH)/platform/service/memory_manager/src" -I"$(SDK_PATH)/platform/emdrv/nvm3/inc" -I"$(SDK_PATH)/platform/security/sl_component/sl_psa_driver/inc" -I"$(SDK_PATH)/platform/security/sl_component/se_manager/inc" -I"$(SDK_PATH)/platform/security/sl_component/se_manager/src" -I"$(SDK_PATH)/util/third_party/segger/systemview/SEGGER" -I"$(SDK_PATH)/platform/common/toolchain/inc" -I"$(SDK_PATH)/platform/service/system/inc" 
CXX_INCLUDES := -I"config" -I"autogen" -I"../../generator" -I"$(SDK_PATH)/../../../examples" -I"$(SDK_PATH)/../../../examples/platform/silabs" -I"$(SDK_PATH)/../../../src" -I"$(SDK_PATH)/../../../src/include" -I"$(SDK_PATH)/../../../zzz_generated/app-common" -I"$(SDK_PATH)/../../nlassert/repo/include" -I"$(SDK_PATH)/../../nlio/repo/include" -I"$(SDK_PATH)/platform/bootloader" -I"$(SDK_PATH)/protocol/bluetooth/config" -I"$(SDK_PATH)/platform/Device/SiliconLabs/EFR32MG26/Include" -I"$(SDK_PATH)/platform/common/inc" -I"$(SDK_PATH)/platform/CMSIS/Core/Include" -I"$(SDK_PATH)/platform/CMSIS/RTOS2/Include" -I"$(SDK_PATH)/platform/service/device_init/inc" -I"$(SDK_PATH)/platform/emdrv/common/inc" -I"$(SDK_PATH)/platform/emlib/inc" -I"$(SDK_PATH)/util/third_party/freertos/cmsis/Include" -I"$(SDK_PATH)/util/third_party/freertos/kernel/include" -I"$(SDK_PATH)/util/third_party/freertos/kernel/portable/GCC/ARM_CM33_NTZ/non_secure" -I"$(SDK_PATH)/platform/service/interrupt_manager/inc" -I"$(SDK_PATH)/platform/service/interrupt_manager/inc/arm" -I"$(SDK_PATH)/platform/service/iostream/inc" -I"$(SDK_PATH)/platform/security/sl_component/sl_mbedtls_support/config" -I"$(SDK_PATH)/platform/security/sl_component/sl_mbedtls_support/config/preset" -I"$(SDK_PATH)/platform/security/sl_component/sl_mbedtls_support/inc" -I"$(SDK_PATH)/util/third_party/mbedtls/include" -I"$(SDK_PATH)/util/third_party/mbedtls/library" -I"$(SDK_PATH)/platform/service/memory_manager/inc" -I"$(SDK_PATH)/platform/service/memory_manager/src" -I"$(SDK_PATH)/platform/emdrv/nvm3/inc" -I"$(SDK_PATH)/platform/security/sl_component/sl_psa_driver/inc" -I"$(SDK_PATH)/platform/security/sl_component/se_manager/inc" -I"$(SDK_PATH)/platform/security/sl_component/se_manager/src" -I"$(SDK_PATH)/util/third_party/segger/systemview/SEGGER" -I"$(SDK_PATH)/platform/common/toolchain/inc" -I"$(SDK_PATH)/platform/service/system/inc" 
