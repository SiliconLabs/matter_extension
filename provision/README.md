...
- J-Link RTT: When the device is physically connected to the host, the GFW can
...
The -i/--inputs argument reads all the required arguments from a provided JSON
...
By default, `provision.py` uses the Matter Test PAA
