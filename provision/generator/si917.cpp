...
static const sl_wifi_device_configuration_t _wifi_config = {
    ...
    .boot_config = { .oper_mode       = SL_SI91X_CLIENT_MODE,
                     ...
                     .tcp_ip_feature_bit_map =
                         (SL_SI91X_TCP_IP_FEAT_DHCPV4_CLIENT | SL_SI91X_TCP_IP_FEAT_HTTP_CLIENT |
                          SL_SI91X_TCP_IP_FEAT_EXTENSION_VALID | SL_SI91X_TCP_IP_FEAT_OTAF | SL_SI91X_TCP_IP_FEAT_DNS_CLIENT),
                     .custom_feature_bit_map     = SL_SI91X_CUSTOM_FEAT_EXTENTION_VALID,
                     .ext_custom_feature_bit_map = (SL_SI91X_EXT_FEAT_XTAL_CLK | SL_SI91X_EXT_FEAT_UART_SEL_FOR_DEBUG_PRINTS |
...
void app_platform_init()
{
    ...
    sl_si91x_trng_program_key((uint32_t *) trngKey, TRNG_KEY_SIZE);
#else
    psa_crypto_init();
#endif
}
