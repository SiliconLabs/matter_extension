...
struct Buffer {
  ...
  size_t Size() {
    return (this->in > this->begin) ? (this->in - this->begin) : 0;
  }
  /** @return Number of bytes read. */
  size_t Offset() {
    return (this->out > this->begin) ? (this->out - this->begin) : 0;
  }
...
struct Argument : public Buffer {
  ...
  Argument(uint8_t *ptr = nullptr, size_t size = 0) : Buffer(ptr, size) {
    Reset();
  }
