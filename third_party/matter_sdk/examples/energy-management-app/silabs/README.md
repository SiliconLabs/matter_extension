...
or Water Heater device, built using Matter and the Silicon Labs Simplicity SDK.
It can be controlled by a Chip controller over an Openthread or Wifi network.
