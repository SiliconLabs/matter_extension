...
#ifndef SL_MATTER_ENABLE_DUAL_STACK
#define SL_MATTER_ENABLE_DUAL_STACK (0)
...
#define LWIP_IPV6_AUTOCONFIG ((LWIP_IPV6) && !(SL_MATTER_ENABLE_DUAL_STACK))
#define LWIP_IPV6_ROUTER_SUPPORT ((LWIP_IPV6) && !(SL_MATTER_ENABLE_DUAL_STACK))
#define LWIP_ND6_LISTEN_RA ((LWIP_IPV6_ND) && !(SL_MATTER_ENABLE_DUAL_STACK))
#define LWIP_ND6_ALLOW_RA_UPDATES ((LWIP_IPV6_ND) && !(SL_MATTER_ENABLE_DUAL_STACK))
