...
#define EMBER_AF_BALLAST_CONFIGURATION_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
#define EMBER_AF_PLUGIN_BALLAST_CONFIGURATION_SERVER
#define EMBER_AF_PLUGIN_BALLAST_CONFIGURATION
