...
void DispatchServerCommand(CommandHandler * apCommandObj, const ConcreteCommandPath & aCommandPath, TLV::TLVReader & aDataTlv)
{
    ...
    bool wasHandled = false;
    {
        switch (aCommandPath.mCommandId)
        {
        case Commands::RegisterClientMonitoring::Id: {
        Commands::RegisterClientMonitoring::DecodableType commandData;
        TLVError = DataModel::Decode(aDataTlv, commandData);
        if (TLVError == CHIP_NO_ERROR) {
        wasHandled = emberAfClientMonitoringClusterRegisterClientMonitoringCallback(apCommandObj, aCommandPath, commandData);
        }
            break;
        }
        case Commands::UnregisterClientMonitoring::Id: {
        Commands::UnregisterClientMonitoring::DecodableType commandData;
        TLVError = DataModel::Decode(aDataTlv, commandData);
        if (TLVError == CHIP_NO_ERROR) {
        wasHandled = emberAfClientMonitoringClusterUnregisterClientMonitoringCallback(apCommandObj, aCommandPath, commandData);
        }
            break;
        }
        default: {
...
void DispatchServerCommand(CommandHandler * apCommandObj, const ConcreteCommandPath & aCommandPath, TLV::TLVReader & aDataTlv)
{
    ...
    bool wasHandled = false;
    {
        ...
        TLVError = DataModel::Decode(aDataTlv, commandData);
        if (TLVError == CHIP_NO_ERROR) {
        wasHandled = emberAfUnitTestingClusterTestNestedStructArgumentRequestCallback(apCommandObj, aCommandPath, commandData);
        }
            break;
        }
        ...
        TLVError = DataModel::Decode(aDataTlv, commandData);
        if (TLVError == CHIP_NO_ERROR) {
        wasHandled = emberAfUnitTestingClusterTestListStructArgumentRequestCallback(apCommandObj, aCommandPath, commandData);
        }
            break;
        }
        ...
        TLVError = DataModel::Decode(aDataTlv, commandData);
        if (TLVError == CHIP_NO_ERROR) {
        wasHandled = emberAfUnitTestingClusterTestNestedStructListArgumentRequestCallback(apCommandObj, aCommandPath, commandData);
        }
            break;
        }
        ...
        TLVError = DataModel::Decode(aDataTlv, commandData);
        if (TLVError == CHIP_NO_ERROR) {
        wasHandled = emberAfUnitTestingClusterTestListNestedStructListArgumentRequestCallback(apCommandObj, aCommandPath, commandData);
        }
            break;
        }
        ...
        TLVError = DataModel::Decode(aDataTlv, commandData);
        if (TLVError == CHIP_NO_ERROR) {
        wasHandled = emberAfUnitTestingClusterTestSimpleOptionalArgumentRequestCallback(apCommandObj, aCommandPath, commandData);
        }
            break;
        }
        ...
        TLVError = DataModel::Decode(aDataTlv, commandData);
        if (TLVError == CHIP_NO_ERROR) {
        wasHandled = emberAfUnitTestingClusterTestEmitTestFabricScopedEventRequestCallback(apCommandObj, aCommandPath, commandData);
        }
            break;
        }
        default: {
...
void DispatchSingleClusterCommand(const ConcreteCommandPath & aCommandPath, TLV::TLVReader & aReader, CommandHandler * apCommandObj)
{
    ...
    case Clusters::ClientMonitoring::Id:
        Clusters::ClientMonitoring::DispatchServerCommand(apCommandObj, aCommandPath, aReader);
        break;
