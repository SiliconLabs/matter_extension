...
class BLEManagerImpl final : public BLEManager, private BleLayer, private BlePlatformDelegate, private BleApplicationDelegate
{
    ...
    void HandleConnectionCloseEvent(const sl_bt_msg_t * evt);
    void HandleWriteEvent(const sl_bt_msg_t * evt);
    void HandleTXCharCCCDWrite(const sl_bt_msg_t * evt);
    void HandleRXCharWrite(const sl_bt_msg_t * evt);
    void HandleTxConfirmationEvent(BLE_CONNECTION_OBJECT conId);
    void HandleSoftTimerEvent(const sl_bt_msg_t * evt);
